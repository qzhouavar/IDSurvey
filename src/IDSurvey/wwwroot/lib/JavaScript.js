    ...
    d.makeChart = function (a, b, c) {
        ...
        switch (e) {
            ...
            case "stock":
                ...
                break;
            case "gantt": f = new d.AmGanttChart(g);
        }
        d.extend(f, b);
        ...
        construct: function (a) {
            ...
            if (a) {
                ...
                switch (this.position) {
                    ...
                    case "left":
                        ...
                        break;
                    case "right": b = e + h + 10 + n, q && (b += 7), c = ("left" == p ? l + 2 : "right" == p ? -2 : l / 2) + this.titleDY, m = -90;
                }
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    "MM" == A && (g = (p - l) / z, 1.5 <= (p - l) / z && (p = p - (g - 1) * z + d.getPeriodDuration("DD", 3), p = d.resetDateToMin(new Date(p), A, 1).getTime(), C += z));
            ...
            if (a) {
                ...
                switch (this.position) {
                    ...
                    case "left":
                        ...
                        h ? (c = 0, e = k) : (c = -1E3, e = 0);
                        break;
                    case "right": d = 0, f = l, h ? (c = 0, e = k) : (c = k, e = k + 1E3);
                }
                            ...
                            if (t = y * h + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t)
                                if (isNaN(x) || Number(d.toFixed(t, x)) == t) {
                                    ...
                                    if (!isNaN(z) && 0 < A && h < r - 1) {
                                        ...
                                        for (H = 1; H < f; H++) {
                                            var Q = this.getCoordinate(t + z * H), Q = new this.axisItemRenderer(this, Q, "", !1, 0, 0, !1, !1, 0, !0);
                                            this.pushAxisItem(Q);
                                        }
                                        this.gridAlpha = K;
                                    }
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
            ...
            this.set = x;
            var u = a.axisThickness, A = a.axisColor, z = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, K = a.gridColor, H = a.dashLength, Q = a.fillColor, M = a.fillAlpha, P = a.labelsEnabled;
            n = a.labelRotationR;
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            if (e) {
                ...
                switch (m) {
                    ...
                    case "bottom":
                        ...
                        break;
                    case "left": m = q ? p ? "right" : "left" : "left";
                }
                ...
                switch (m) {
                    ...
                    case "inside":
                        ...
                        break;
                    case "middle": "column" == this.type && (l = !0, q ? b -= (b - r) / 2 + y - 3 : c -= (c - w) / 2 + y - 3);
                }
            ...
            if (1 < a.length) {
                ...
                w && (t = w);
                var w = g.fillColorsR, y = g.fillColorsSwitched;
                y && (w = y);
                var x = g.dashLength;
                (y = g.dashLengthSwitched) && (x = y);
                var y = g.negativeLineColor, u = g.negativeFillColors, A = g.negativeFillAlphas, z = g.baseCoord;
            ...
            if (1 < a.length) {
                ...
                g.push(l);
                g.push(k);
                var m = this.lineAlpha, n = this.lineThickness, g = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, w = this.negativeFillColors, y = this.negativeFillAlphas, x = this.baseCoord, u = this.lineColorSwitched;
                u && (p = u);
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + x + "," + b[b.length - 1], n += " L" + x + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + x, n += " L" + a[0] + "," + x), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(h, m, p, NaN, 0, 0, t, q, g, n, u), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), w || void 0 !== r) && (y || (y = q), w || (w = r), a = new d.Bezier(h, a, b, NaN, 0, 0, w, y, g, n, u), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k);
            }
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.drop ? (h = C / 1.6, l = 0, "V" == x && (x = "down"), "H" == x && (x = "left"), "down" == x && (D = a + 1, z = b - h - h / 3), "up" == x && (l = 180, D = a + 1, z = b + h + h / 3), "left" == x && (l = 270, D = a + h + h / 3 + 2, z = b), "right" == x && (l = 90, D = a - h - h / 3 + 2, z = b), k = z - H / 2 + 1, m = D - K / 2 - 1, q = d.drop(g, h, l, q, w, r, p, aa)) : 0 < u || 0 === y ? (0 < M && (a = d.rect(g, C, A, q, 0, r + 1, P, M, u), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(g, C, A, q, w, r, p, aa, u)) : (t = [], u = [], "H" != x ? (h = a - D, h > C - y && (h = C - y), h < y && (h = y), t = [0, h - y, a - D, h + y, C, C, 0, 0], u = Q ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (x = b - z, x > A - y && (x = A - y), x < y && (x = y), u = [0, x - y, b - z, x + y, A, A, 0, 0], t = a < h + (l - h) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < M && (a = d.polygon(g, t, u, q, 0, r, P, M), a.translate(1, 1), f.push(a)), q = d.polygon(g, t, u, q, w, r, p, aa));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({ translate: D - g + "," + z }, b, "easeOutSine"), n && (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate({ node: n }, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({ node: n }, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = D - g;
                    this.prevY = z;
                    this.prevTX = m;
                    this.prevTY = k;
...
(function () {
    ...
    d.bullet = function (a, b, c, e, g, f, h, k, l, m, n, q, p) {
        ...
        switch (b) {
            ...
            case "yError":
                ...
                t.push(d.line(a, [-l, l], [c / 2, c / 2], e, g, f));
                break;
            case "xError": t = a.set(), t.push(d.line(a, [-c / 2, c / 2], [0, 0], e, g, f)), t.push(d.line(a, [-c / 2, -c / 2], [-l, l], e, g, f)), t.push(d.line(a, [c / 2, c / 2], [-l, l], e, g, f));
        }
        t && t.pattern(n, NaN, q);
        return t;
    };
    ...
    d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
        ...
        h = r(h);
        k = r(k);
        var w = r(h / f * k), y = d.VML, x = 359.5 + f / 100;
        359.94 < x && (x = 359.94);
        g >= x && (g = x);
        var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, z = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * h, D = b + Math.sin((e + g) * u) * f, C = c - Math.cos((e + g) * u) * h, K = b + Math.sin((e + g) * u) * k, u = c - Math.cos((e + g) * u) * w, H = { fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"] }, Q = 0;
        180 < Math.abs(g) && (Q = 1);
        e = a.set();
        var M;
        ...
        if (0 < l) {
            P = " M" + x + "," + (A + l) + " L" + z + "," + (B + l);
            y ? (M || (P += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + z + "," + (B + l) + "," + D + "," + (C + l)), P += " L" + K + "," + (u + l), 0 < k && (M || (P += " B" + (b - k) + "," + (l + c - w) + "," + (b + k) + "," + (l + c + w) + "," + K + "," + (l + u) + "," + x + "," + (l + A)))) : (P += " A" + f + "," + h + ",0," + Q + ",1," + D + "," + (C + l) + " L" + K + "," + (u + l), 0 < k && (P += " A" + k + "," + w + ",0," + Q + ",0," + x + "," + (A + l)));
            P += " Z";
            var ia = l;
            y && (ia /= 10);
...
(function () {
    ...
    d.Bezier = d.Class({
        construct: function (a, b, c, e, g, f, h, k, l, m, n) {
            ...
            var c = a[1].x - a[0].x, e = a[1].y - a[0].y, g = d.bezierX, f = d.bezierY;
            b.push({ x: a[0].x + c / g, y: a[0].y + e / f });
            var h;
            for (h = 1; h < a.length - 1; h++) {
                var k = a[h - 1], l = a[h], e = a[h + 1];
                isNaN(e.x) && (e = l);
                isNaN(l.x) && (l = k);
                isNaN(k.x) && (k = l);
                c = e.x - l.x;
            ...
            var g = Math.round, f = this.getPointOnSegment(a, b, .75), h = this.getPointOnSegment(d, c, .75), k = (d.x - a.x) / 16, l = (d.y - a.y) / 16, m = this.getPointOnSegment(a, b, .375);
...
(function () {
    ...
    d.stringToDate = function (a, b) {
        var c = {}, e = [{ pattern: "YYYY", period: "year" }, { pattern: "YY", period: "year" }, { pattern: "MM", period: "month" }, { pattern: "M", period: "month" }, { pattern: "DD", period: "date" }, { pattern: "D", period: "date" }, { pattern: "JJ", period: "hours" }, { pattern: "J", period: "hours" }, { pattern: "HH", period: "hours" }, { pattern: "H", period: "hours" }, { pattern: "KK", period: "hours" }, { pattern: "K", period: "hours" }, { pattern: "LL", period: "hours" }, { pattern: "L", period: "hours" }, { pattern: "NN", period: "minutes" }, { pattern: "N", period: "minutes" }, { pattern: "SS", period: "seconds" }, { pattern: "S", period: "seconds" }, { pattern: "QQQ", period: "milliseconds" }, { pattern: "QQ", period: "milliseconds" }, { pattern: "Q", period: "milliseconds" }], g = !0, f = b.indexOf("AA");
