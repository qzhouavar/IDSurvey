function countChecked() {
    ...
    var e = $(".bulk_action input[name='table_records']:checked").length; e ? ($(".column-title").hide(),
    $(".bulk-actions").show(),
    ...
    var n = function (e, t, n) {
        var i; return function () {
            ...
            var a = this, o = arguments; i ? clearTimeout(i) : n && e.apply(a, o),
            i = setTimeout(c, t || 100)
        }
    };
    jQuery.fn[t] = function (e) { return e ? this.bind("resize", n(e)) : this.trigger(t) }
}(jQuery, "smartresize");
...
$(document).ready(function () {
    var e = function () {
        ...
        i = n > e ? n : e; i -= $NAV_MENU.height() + t, $RIGHT_COL.css("min-height", i)
    };
...
$(document).ready(function () {
    $(".collapse-link").on("click", function () {
        ...
        t = $(this).find("i"),
        n = e.find(".x_content");
        e.attr("style") ? n.slideToggle(200, function () { e.removeAttr("style") }) : (n.slideToggle(200),
        e.css("height", "auto")),
...
$(document).ready(function () {
    if ($(".js-switch")[0]) {
        ...
        e.forEach(function (e) { new Switchery(e, { color: "#26B99A" }) })
    }
}),
